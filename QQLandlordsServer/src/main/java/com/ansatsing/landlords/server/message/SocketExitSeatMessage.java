 ...
 *
 */
public class SocketExitSeatMessage extends ExitSeatMessage<Socket> {
	private final static Logger LOGGER = LoggerFactory.getLogger(SocketExitSeatMessage.class);
	public SocketExitSeatMessage(Player player,Socket socket,Map<Integer, String> enterSeatMap,Map<Integer, Map<String, Socket>> gameGroups,Map<String, Socket> nameToSocket) {
		this.player = player;
		this.socket = socket;
