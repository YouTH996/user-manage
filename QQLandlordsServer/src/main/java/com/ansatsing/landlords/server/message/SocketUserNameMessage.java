 ...
 *
 */
public class SocketUserNameMessage extends UserNameMessage<Socket> {
	private final static Logger LOGGER = LoggerFactory.getLogger(SocketUserNameMessage.class);
	public SocketUserNameMessage(Player player,Socket socket,Map<Integer, String> enterSeatMap,Map<Integer, Map<String, Socket>> gameGroups,Map<String, Socket> nameToSocket) {
		this.player = player;
		this.socket = socket;
